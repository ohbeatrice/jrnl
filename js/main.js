;(function () {
	...
	var offCanvass = function() {
		$('body').on('click', '.js-what-nav-toggle', function(event){

			var $this = $(this);

			$('#what-offcanvass').toggleClass('what-awake');
			$('#what-page, #what-menu').toggleClass('what-sleep');




			if ( $('#what-offcanvass').hasClass('what-awake') ) {
	...
	var footerFixed = function() {
		var fh = $('#what-footer').innerHeight();
		$('#what-wrap').css({
			marginBottom : fh + 'px'
		});
	...
	var mobileMenuOutsideClick = function() {
	    ...
	    var container = $("#what-offcanvass, .js-what-nav-toggle");
	    if (!container.is(e.target) && container.has(e.target).length === 0) {
	    	if ( $('#what-offcanvass').hasClass('what-awake') ) {
	    		$('#what-offcanvass').removeClass('what-awake');
	    		$('#what-page, #what-menu').removeClass('what-sleep');

	    		$('.js-what-nav-toggle').removeClass('active');
	    	}
	    }
		});
		...
		$(window).scroll(function(){
			...
			if ( $(window).scrollTop() < 500 ) {
				...
				$('#what-offcanvass ul li').removeClass('active');
				$('#what-offcanvass ul li').first().addClass('active');
			}
	...
	var introWayPoint = function() {
		if ( $('#what-hero').length > 0 ) {
			$('#what-hero').waypoint( function( direction ) {
	...
	var clientAnimate = function() {
		if ( $('#what-clients').length > 0 ) {	
			$('#what-clients .to-animate').each(function( k ) {
	...
	var clientWayPoint = function() {
		if ( $('#what-clients').length > 0 ) {
			$('#what-clients').waypoint( function( direction ) {
	...
	var featuresAnimate = function() {
		if ( $('#what-features').length > 0 ) {	
			$('#what-features .to-animate').each(function( k ) {
	...
	var featuresWayPoint = function() {
		if ( $('#what-features').length > 0 ) {
			$('#what-features').waypoint( function( direction ) {
	...
	var features2AnimateTitle = function() {
		if ( $('#what-features-2').length > 0 ) {	
			$('#what-features-2 .to-animate').each(function( k ) {
	...
	var features2WayPoint = function() {
		if ( $('#what-features-2').length > 0 ) {
			$('#what-features-2').waypoint( function( direction ) {
	...
	var counterWayPoint = function() {
		if ( $('#what-counter').length > 0 ) {
			$('#what-counter').waypoint( function( direction ) {
	...
	var productsAnimate = function() {
		if ( $('#what-products').length > 0 ) {	
			$('#what-products .to-animate').each(function( k ) {
	...
	var productsWayPoint = function() {
		if ( $('#what-products').length > 0 ) {
			$('#what-products').waypoint( function( direction ) {
	...
	var ctaAnimate = function() {
		if ( $('#what-cta').length > 0 ) {	
			$('#what-cta .to-animate').each(function( k ) {
	...
	var ctaWayPoint = function() {
		if ( $('#what-cta').length > 0 ) {
			$('#what-cta').waypoint( function( direction ) {
	...
	var pricingAnimate = function() {
		if ( $('#what-pricing').length > 0 ) {	
			$('#what-pricing .to-animate').each(function( k ) {
	...
	var pricingWayPoint = function() {
		if ( $('#what-pricing').length > 0 ) {
			$('#what-pricing').waypoint( function( direction ) {
	...
	var features3Animate = function() {
		if ( $('#what-features-3').length > 0 ) {	
			$('#what-features-3 .to-animate').each(function( k ) {
	...
	var features3WayPoint = function() {
		if ( $('#what-features-3').length > 0 ) {
			$('#what-features-3').waypoint( function( direction ) {
	...
	var faqsAnimate = function() {
		if ( $('#what-faqs').length > 0 ) {	
			$('#what-faqs .to-animate').each(function( k ) {
	...
	var faqsWayPoint = function() {
		if ( $('#what-faqs').length > 0 ) {
			$('#what-faqs').waypoint( function( direction ) {
